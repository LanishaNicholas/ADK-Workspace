...
Demonstrates ADK's generate_content_congfig with different settings.
"""
...
#Uses low temprature for consistency, strict safety for accuracy
...
factual_agent = LlmAgent(
    ...
    generate_content_config=types.GenerateContentConfig(
        temperature=0.1, #Very low for consistency
             max_output_tokens=500, #Limit output to concise facts
             top_p=0.8, #Low top_p for focused output
             safety_settings=[
                 types.SafetySetting(
...
#Agent 2: Optimized for creative Brainstroming
#Uses high temprature for creativity, Pro model for better ideas
creative_agent = LlmAgent(
    ...
    - Explorer unconventional approaches
    
    Be creative, varied, and thought-provoking.""",
    generate_content_config=types.GenerateContentConfig(
        temperature=0.9, #High for creativity
        max_output_tokens=2000, #Allow more expansive ideas
...
#Switch to creative_agent to test fiffrent behavior
